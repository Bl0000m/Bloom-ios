...
class SignInViewController: UIViewController {
  ...
  init(signInViewModel: SignInViewModelProtocol, signInCoordinator: SignInCoordinator) {
  ...
  @objc private func moveToBack() {
    signInCoordinator.backButtonTapped()
  }
   
  @objc private func moveToForgotPassword() {
    signInCoordinator.forgorPasswordTapped()
  }
  
  @objc private func moveToAccount() {
    signInCoordinator.moveToAccount()
  }
  
  @objc private func moveToCreateAccount() {
    signInCoordinator.moveToCreateAccount()
  }
